@if ($paginator->hasPages())
    ...
    <span aria-current="page">
        <span class="relative inline-flex items-center px-4 py-2 -ml-px text-sm font-bold text-white bg-blue-900 border border-blue-900 cursor-default leading-5 rounded">
            {{ $page }}
        </span>
    </span>
@else
