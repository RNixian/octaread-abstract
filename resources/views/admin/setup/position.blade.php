...
<body class="bg-gray-100 flex items-center justify-center min-h-screen">
 ...
 <h2 class="text-2xl font-bold mb-6 text-center">Position</h2>
        ...
        <form action="{{ route('admin.setup.storeposition') }}" method="POST" enctype="multipart/form-data" class="space-y-4">
            @csrf
              <div class="mb-4">
...
<div class="mt-8"></div>
  ...
  <!-- Search and Filter -->
 <form method="GET" action="{{ url('/admin/setup/position') }}" id="searchForm" class="w-full mb-6 flex flex-col md:flex-row items-center gap-2">
  <input 
    type="text" 
    name="search" 
