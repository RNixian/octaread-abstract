...
<div id="sidebar"
  ...
  <div class="text-center mb-4">
    <img src="{{ url('images/load.png') }}" alt="Logo" class="mx-auto" style="height: 150px; width: 150px;">
  </div>
...
<li class="relative">
  ...
  <ul id="accountsDropdown"
    class="absolute left-0 mt-1 w-full bg-white shadow-md rounded hidden z-10 text-black">
    <li>
      <a href="{{ url('/admin/account/useraccount') }}" class="block py-2 px-4 hover:bg-blue-200">
        User Accounts
      </a>
    </li>
    ...
    <li>
      <a href="{{ url('/admin/account/guestlog') }}" class="block py-2 px-4 hover:bg-blue-200">
        Guest Logs
      </a>
    </li>
  </ul>
...
@endif
  ...
  <div class="mt-20 pt-4 border-t border-gray-300">
    <form method="POST" action="{{ route('admin.logout') }}">
      @csrf
      <button type="submit" class="flex items-center gap-2 hover:bg-red-600 text-white font-bold py-2 px-6 rounded">
