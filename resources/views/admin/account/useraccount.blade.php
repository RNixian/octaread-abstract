...
<body class="bg-gray-100 flex items-center justify-center min-h-screen">
 ...
 <!-- Search and Filter -->
 <form method="GET" action="{{ url('/admin/account/useraccount') }}" class="flex flex-col md:flex-row justify-between items-center mb-4 gap-2">
      ...
      <tbody>
        @foreach($departmentmodel as $data)
          <tr class="bg-white odd:bg-gray-100 hover:bg-gray-200">
            ...
            <td class="px-4 py-2 border-b">{{ $data->course }}</td>
            <td class="px-4 py-2 border-b">{{ $data->birthdate }}</td>
          ...
          <div class="bg-white rounded-lg shadow-lg w-full max-w-2xl p-6 relative">
            ...
            <form id="updateForm" action="{{ route('updateuseracc', ['id' => '__ID__']) }}" method="POST" enctype="multipart/form-data">
              ...
              <input type="hidden" name="id" id="dept_id" value="">
                ...
                <div>
                  <label class="block text-gray-700 font-bold mb-2" for="edit_dept">First Name</label>
                ...
                <div>
                    <label class="block text-gray-700 font-bold mb-2" for="edit_dept">Middle Name</label>
                  ...
                  <div>
                    <label class="block text-gray-700 font-bold mb-2" for="edit_dept">Last Name</label>
                  ...
                  <div>
                    <label class="block text-gray-700 font-bold mb-2" for="edit_dept">School Id</label>
                  ...
                  <div>
                    <label class="block text-gray-700 font-bold mb-2" for="edit_dept">Course</label>
                  ...
                  <div>
                    <label class="block text-gray-700 font-bold mb-2" for="edit_dept">Birthdate</label>
