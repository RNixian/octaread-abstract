    ...
    <div class="flex-1 p-8">
      <div class="max-w-6xl w-full mx-auto">
        ...
        <div class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-6">
         ...
         <!-- Search and Filter -->
    <form method="GET" action="{{ url('/admin/undergraduate') }}" class="flex flex-col md:flex-row justify-between items-center mb-4 gap-2">
...
@if($undercountgrads > 0)
    <p class="mt-4 text-sm text-gray-600">Count: {{ $undercountgrads }}</p>
@else
